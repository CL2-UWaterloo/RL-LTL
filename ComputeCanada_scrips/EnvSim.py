...
def make_move(grid_world, loc_i, loc_j, move, error_chance=0, right_chance=0.5):
...
def run_episode(grid_world, model, LTL_formula, predicates, n_steps=150, C=3, tow=1, n_samples=300, N={}, W={}, Q={}, P={},
                random_move_chance=0, verbose=0):
    state_history = []
    action_history = []
    better_policy = []
    trajectory = []
    ...
    for step in range(n_steps):
        ...
        if location in predicates['c']:break
...
def MCTS_rec(model, root, tree, LTL_formula, trajectory, predicates, N={}, W={}, Q={}, P={}, C=1, depth=100, random_move_chance=0):
  ...
  ######## check if LTL specs are violated
  if location in predicates['c']: return -1
